    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100 dark:from-gray-900 dark:to-gray-800">
      ...
      <header className="bg-white dark:bg-gray-800 shadow-lg border-b border-gray-200 dark:border-gray-700 sticky top-0 z-20">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-6 text-center relative">
          ...
          <h1 className="text-3xl sm:text-4xl font-bold text-gray-900 dark:text-white">{character.name}</h1>
        </div>
      </header>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 justify-items-center lg:justify-items-stretch">
          ...
          <div className="lg:col-span-1 w-full max-w-md lg:max-w-none">
            <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-xl overflow-hidden sticky top-28 border dark:border-gray-700">
              ...
              <div className="p-8 text-center">
                <h2 className="text-2xl font-bold text-gray-900 dark:text-white mb-6">{character.name}</h2>
                ...
                <div className="space-y-4">
                  <div className="bg-gray-50 dark:bg-gray-700 rounded-xl p-4">
                    <span className="text-sm font-semibold text-gray-500 dark:text-gray-400 uppercase tracking-wide">Species</span>
                    <p className="text-lg font-medium text-gray-900 dark:text-white mt-1">{character.species}</p>
                  </div>
                  <div className="bg-gray-50 dark:bg-gray-700 rounded-xl p-4">
                    <span className="text-sm font-semibold text-gray-500 dark:text-gray-400 uppercase tracking-wide">Gender</span>
                    <p className="text-lg font-medium text-gray-900 dark:text-white mt-1">{character.gender}</p>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div className="lg:col-span-2 space-y-8 w-full">
            ...
            <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-xl p-8 border dark:border-gray-700">
              <h2 className="text-2xl font-bold text-gray-900 dark:text-white mb-8 text-center">Origin & Location</h2>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                <div className="bg-gradient-to-br from-blue-50 to-indigo-50 dark:from-blue-900 dark:to-indigo-900 rounded-xl p-6 border border-blue-100 dark:border-blue-800 text-center">
                  <h3 className="text-sm font-semibold text-blue-600 dark:text-blue-400 uppercase tracking-wide mb-3">Origin</h3>
                  <p className="text-xl font-bold text-gray-900 dark:text-white">{character.origin?.name || 'Unknown'}</p>
                </div>
                <div className="bg-gradient-to-br from-green-50 to-emerald-50 dark:from-green-900 dark:to-emerald-900 rounded-xl p-6 border border-green-100 dark:border-green-800 text-center">
                  <h3 className="text-sm font-semibold text-green-600 dark:text-green-400 uppercase tracking-wide mb-3">Last Known Location</h3>
                  <p className="text-xl font-bold text-gray-900 dark:text-white mb-3">{character.location?.name || 'Unknown'}</p>
                  {location && (
            ...
            <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-xl p-8 border dark:border-gray-700">
              <h2 className="text-2xl font-bold text-gray-900 dark:text-white mb-8 text-center">
                Episodes <span className="text-lg font-normal text-gray-500 dark:text-gray-400">({episodes.length})</span>
              </h2>
              ...
              {episodes.length > 0 ? (
                  ...
                  {episodes.map((episode) => (
                    ...
                    >
                      <div className="flex justify-between items-start mb-3">
                        <h3 className="font-bold text-gray-900 dark:text-white text-base leading-tight pr-2">{episode.name}</h3>
                ...
                <div className="text-center py-12 bg-gray-50 dark:bg-gray-700 rounded-xl">
                  ...
                  <h3 className="text-lg font-semibold text-gray-900 dark:text-white mb-2">No Episodes Available</h3>
                  <p className="text-gray-600 dark:text-gray-300">Episode information is not available for this character</p>
                </div>
              )}
            </div>
          </div>
