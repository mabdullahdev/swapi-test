      ...
      <div className="relative mb-6">
        ...
        <div className="absolute top-3 right-3">
          <span className={`inline-flex items-center px-3 py-1 rounded-full text-xs font-medium shadow-sm ${
            statusInfo.className === 'status-alive' ? 'bg-green-100 dark:bg-green-900 text-green-800 dark:text-green-200 border border-green-200 dark:border-green-700' :
            statusInfo.className === 'status-dead' ? 'bg-red-100 dark:bg-red-900 text-red-800 dark:text-red-200 border border-red-200 dark:border-red-700' :
      ...
      <div className="space-y-4 px-2">
        ...
        <div className="space-y-3">
          <div className="flex items-center justify-between text-sm">
            <span className="font-medium text-gray-500 dark:text-gray-400">Species:</span>
            <span className="text-gray-900 dark:text-white font-semibold">{character.species}</span>
          </div>
          <div className="flex items-center justify-between text-sm">
            <span className="font-medium text-gray-500 dark:text-gray-400">Location:</span>
            <span className="text-gray-900 dark:text-white font-semibold truncate ml-2 text-right">{character.location?.name || 'Unknown'}</span>
          </div>
        </div>
      </div>
    </Link>
